<div class="container">
        <div class="row">
            ...
            <div class="row overflow-hidden position-relative btn1">
                            <input type="file" class="btn btn-info" accept="image/*" name="photo" onchange="loadFile(event)" value="Choisir un avatar">
                            <button class="btn btn-info border-0 rounded mb-2">Choisir un avatar</button>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                        <button type="submit" name="compte" class="btn btn-info ">Créer un compte</button>
                        </div>
                    </div>
            </div>
        </div>
